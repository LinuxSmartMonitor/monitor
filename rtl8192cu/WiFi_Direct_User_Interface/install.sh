...
if [ -e ../wpa_supplicant_hostapd/wpa_supplicant_hostapd-0.8_rtw_20120803.zip ]; then
        echo "Checking wpa_supplicant_hostapd-0.8_rtw_20120803.zip"
else
        echo "wpa_supplicant_hostapd-0.8_rtw_20120803.zip doesn't exist in corresponding folder"
        exit
fi
